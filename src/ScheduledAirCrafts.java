...
public class ScheduledAirCrafts {
	...
	public ScheduledAirCrafts(Route route, AirCraft airCraft, int buisnessClassRate, int economyClassrate, int departureTime, int arrivalTime, String date) {
